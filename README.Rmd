...
Specification)](https://developers.google.com/transit/gtfs/) data, using the
[Connection Scan Algorithm](https://arxiv.org/abs/1703.05997). Among the
...
library (gtfsrouter)
```
```{r for-real, eval = TRUE, echo = FALSE, message = FALSE}
