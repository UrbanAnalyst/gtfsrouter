[![Build Status](https://travis-ci.org/ATFutures/gtfs-router)](https://travis-ci.org/ATFutures/gtfs-router) 
...
[![Project Status: Concept](http://www.repostatus.org/badges/latest/concept)](http://www.repostatus.org/#concept)

# GTFS Router

Find quickest routes with [GTFS
feed](https://developers.google.com/transit/gtfs/). Among the additional aims of
this repo are to quantify the dynamic stability of a GTFS network in time and
space, and to identify "weakest nodes" as those where a temporal disruption
propogates out to have the greatest effect throughout the broader network.
