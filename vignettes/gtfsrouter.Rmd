...
```
The complentary function, `go_to_work()` routes in the reverse direction. These
...
acheived simply by creating a file named `.Renviron` in the user's root
...
fdir <- file.path (here::here (), "fig")
fig_name <- file.path (fdir, "isochrone.png")
