...
stop_times <- data.table::fread ("./data-raw/stop_times.txt", showProgress = FALSE)
...
stops <- data.table::fread ("./data-raw/stops.txt", showProgress = FALSE)
...
transfers <- data.table::fread ("./data-raw/transfers.txt", showProgress = FALSE)
