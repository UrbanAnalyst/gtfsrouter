...
// rcpp_traveltimes
Rcpp::IntegerMatrix rcpp_traveltimes(Rcpp::DataFrame timetable, Rcpp::DataFrame transfers, const size_t nstations, const size_t ntrips, const std::vector <size_t> start_stations, const int start_time, const int end_time, const bool minimise_transfers);
RcppExport SEXP _gtfsrouter_rcpp_traveltimes(SEXP timetableSEXP, SEXP transfersSEXP, SEXP nstationsSEXP, SEXP ntripsSEXP, SEXP start_stationsSEXP, SEXP start_timeSEXP, SEXP end_timeSEXP, SEXP minimise_transfersSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::DataFrame >::type timetable(timetableSEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type end_time(end_timeSEXP);
    Rcpp::traits::input_parameter< const bool >::type minimise_transfers(minimise_transfersSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_traveltimes(timetable, transfers, nstations, ntrips, start_stations, start_time, end_time, minimise_transfers));
    return rcpp_result_gen;
END_RCPP
}
