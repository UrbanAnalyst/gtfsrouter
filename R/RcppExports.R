...
#'
#' @noRd
rcpp_traveltimes <- function(timetable, transfers, nstations, start_stations, start_time, minimise_transfers) {
    .Call(`_gtfsrouter_rcpp_traveltimes`, timetable, transfers, nstations, start_stations, start_time, minimise_transfers)
}
